...
import { swapShift } from "@/api/functions/shift.api";
...
export const ShiftBoxParticipant = ({
  shifts = [],
  isClient,
  isMonthly,
  bulkaction,
...
export default function TimeSheetTable({
  ...
  useEffect(() => {
    if (
      ...
      // console.log(
      //   "Shift Id List is here formatted::::::::::::",
      //   formattedShiftIds
      // );
      // console.log(
      //   "Shift Id List is here all selected::::::::::::",
      //   allSelectedData
      // );
      // console.log("Shift Id List is only ::::::::::::", ShiftIdList);
            ...
            <Typography
              ...
              sx={{
                ...
                color:
                  ...
                  _carer.name === "Pick Up Shift"
                    ? "red"
                    : "#000000", // Change color conditionally
                textTransform:
                  _carer.name === "Open Shift" ||
                  _carer.name === "Pick Up Shift"
                    ? "uppercase"
                    : "none" // Transform text to uppercase conditionally
              }}
            >
              {_carer.name}
            </Typography>
